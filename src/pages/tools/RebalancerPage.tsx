        ...
        <div className="lg:grid lg:grid-cols-5 lg:gap-6">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="grid grid-cols-3 gap-2 mb-5 lg:hidden">
              {[
                { value: 25, suffix: "+", label: "Chains", icon: Layers },
                { label: "Scheduling", textValue: "Auto", icon: Sliders },
                { value: 1, suffix: "%", label: "Threshold", icon: PieChart },
              ].map((stat) => (
          ...
          <div className="lg:col-span-2 space-y-4 mt-5 lg:mt-0">
            <div className="lg:sticky lg:top-20 space-y-4">
              ...
              <div className="hidden lg:grid grid-cols-1 gap-3">
                {[
                  { value: 25, suffix: "+", label: "Chains Supported", icon: Layers },
                  { label: "Auto Scheduling", textValue: "Auto", icon: Sliders },
                  { value: 1, suffix: "%", label: "Min Threshold", icon: PieChart },
                ].map((stat) => (
