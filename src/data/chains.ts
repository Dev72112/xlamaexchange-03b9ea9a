...
// Use reliable CDN sources for chain icons with multiple fallbacks
const CHAIN_ICONS = {
  // X Layer - use OKB logo from CoinGecko
  ...
  mode: 'https://assets.coingecko.com/coins/images/34521/small/mode-logo.png',
  aurora: 'https://assets.coingecko.com/coins/images/20582/small/aurora.png',
...
export const SUPPORTED_CHAINS: Chain[] = [
  ...
  {
    chainIndex: '1313161554',
    chainId: 1313161554,
    name: 'Aurora',
    shortName: 'AURORA',
    icon: CHAIN_ICONS.aurora,
