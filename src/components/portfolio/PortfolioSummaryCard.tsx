/**
 * PortfolioSummaryCard - Portfolio overview stats
...
// Animated counter for value changes - CSS based
function AnimatedValue({ value, prefix = '$' }: { value: number; prefix?: string }) {
  ...
  return (
    <span className="animate-fade-in-simple">
...
export function PortfolioSummaryCard({
  ...
  return (
    <Card className={cn("glass border-border/50 overflow-hidden glow-border-animated shadow-premium gpu-accelerated", className)}>
      {/* Animated gradient top border - CSS based */}
      <div 
        className="h-1 bg-gradient-to-r from-primary via-chart-2 to-chart-4 animate-glow-bar-expand"
      />
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  "sweep-effect shadow-premium-hover performance-critical animate-fade-in"
                )}
                style={staggerStyle}
              >
                {/* Icon with glow */}
                ...
                {item.change && (
                  <div 
                    className={cn(
                      "flex items-center gap-1 text-xs mt-1 animate-fade-in",
                ...
                {item.percentage !== undefined && (
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <div className="flex-1 h-1.5 bg-secondary rounded-full overflow-hidden">
                      <div 
                        className="h-full bg-success rounded-full transition-all duration-800 ease-out"
